...
"[project]/app/oauth/redirect/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        "OAuthRedirectPage.useEffect": ()=>{
            ...
            if (accessToken && refreshToken && name && userId && role) {
                ...
                const timer = setTimeout({
                    "OAuthRedirectPage.useEffect.timer": ()=>{
                        router.push("/login");
                    }
                }["OAuthRedirectPage.useEffect.timer"], 3000);
                return ({
                    "OAuthRedirectPage.useEffect": ()=>clearTimeout(timer)
                })["OAuthRedirectPage.useEffect"];
            }
        }
    }["OAuthRedirectPage.useEffect"], [
...
_s(OAuthRedirectPage, "8i1PHtDhDf9NMpKTkROQKKwA/RI=", false, function() {
    return [
...
//# sourceMappingURL=_0d836b58._.js.map